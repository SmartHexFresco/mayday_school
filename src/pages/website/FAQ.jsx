...
const FAQ = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentImageIndex((prev) => (prev + 1) % faqImages.length)
    }, 3000)
  ...
  const faqs = [
    {
      question: "Can school fees be paid in installments?",
      answer: "Yes, we offer flexible payment plans. School fees can be paid termly or in multiple installments. Please contact our accounts office for a detailed payment schedule."
    },
    {
      question: "What curriculum does the school provide?",
      answer: "We follow the Nigerian National Curriculum enhanced with modern teaching methodologies, preparing students for FSLC, Common Entrance, and other national examinations."
    },
    {
      question: "Does the school offer scholarship programs?",
      answer: "Yes, we offer merit-based scholarships and financial aid for eligible students based on entrance examination performance."
    },
    {
      question: "What extracurricular activities are available?",
      answer: "We offer Debate Club, Science Club, Art Club, Drama Club, Press Club, Mathematics Club, Sports, Music, and Cultural activities."
    },
    {
      question: "Do you have a school bus service?",
      answer: "Yes, we provide reliable school bus transportation within designated routes for student safety and convenience."
    },
    {
      question: "How can I schedule a school tour?",
      answer: "Contact our admissions office via phone, email, or WhatsApp to schedule a convenient time for a school tour."
    },
    {
      question: "What is the admission process?",
      answer: "Purchase admission form, take entrance examination/interview, submit required documents, pay fees, and resume."
    },
    {
      question: "What is the student-to-teacher ratio?",
      answer: "We maintain a low student-to-teacher ratio of approximately 15:1 for personalized attention."
    }
  ]

  return (
    <div className="pt-26 bg-gray-50 min-h-screen">
      {/* Hero Section with 3-Second Slideshow */}
      <section className="relative h-[350px] md:h-[400px] overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div 
              ...
              style={{ backgroundImage: `url('${faqImages[currentImageIndex]}')` }}
            >
