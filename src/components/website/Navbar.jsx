  ...
  return (
    ...
    >
      <div className="bg-blue-700 text-white text-xs sm:text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-9 flex items-center justify-center sm:justify-between gap-3">
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-20 flex items-center justify-between">
          ...
          >
            <div className="w-11 h-11 bg-blue-700 rounded-xl flex items-center justify-center shadow-sm">
          ...
          <ul className="hidden lg:flex items-center gap-1 bg-gray-50 border border-gray-100 rounded-full p-1">
            {navLinks.map((link) => (
              <li key={link.path}>
                <NavLink
                  to={link.path}
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              to="/portal/student-login"
              className="inline-flex items-center gap-2 text-gray-700 hover:text-blue-700 font-semibold text-sm transition-colors"
            >
            ...
            <Link
              to="/admissions"
              className="inline-flex items-center gap-2 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-bold px-5 py-3 rounded-full transition-colors shadow-sm"
            >
              Apply Now
          ...
          <button
            ...
            className="lg:hidden w-10 h-10 rounded-lg flex items-center justify-center text-gray-700 hover:bg-gray-100 transition-colors"
            aria-label="Toggle menu"
          >
        ...
        <div className="px-4 py-4 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-3 border-t border-gray-100">
            <Link
              to="/portal/student-login"
              onClick={closeMenu}
              className="flex items-center justify-center gap-2 border border-gray-200 text-gray-700 hover:text-blue-700 hover:border-blue-200 text-sm font-semibold px-4 py-3 rounded-xl"
            >
              <UserRound className="w-4 h-4" />
              Portal
            </Link>
            ...
            <Link
              to="/admissions"
              onClick={closeMenu}
              className="flex items-center justify-center gap-2 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-bold px-4 py-3 rounded-xl"
            >
              Apply Now
              <ArrowRight className="w-4 h-4" />
            </Link>
